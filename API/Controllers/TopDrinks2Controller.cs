...
{
    public class TopDrinks2Controller : ApiController
    {
        ...
        public IHttpActionResult Get([FromUri]string duration)
        {
            ...
            switch (duration)
            {
                case "Last Month (30 days)":
                    ...
                    return Ok(topDrinks.OrderByDescending(x => x.Millimeters).Take(5).ToList());
                    break;
                case "Last Week (7 days)":
                    ...
                    return Ok(topDrinks2.OrderByDescending(x => x.Millimeters).Take(5).ToList());
                    break;
            }
            return Ok();
        }
